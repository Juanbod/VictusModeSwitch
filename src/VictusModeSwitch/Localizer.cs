...
internal sealed class Localizer
{
    ...
    private static string Russian(string key) => key switch
    {
        ...
        "StartWithWindowsDescription" => "Автоматически запускает приложение в трее после входа в систему",
        "StartupChangeError" => "Не удалось изменить автозапуск. Проверьте доступ к настройкам Windows.",
        "HpServices" => "Приостанавливать лишние службы HP",
        "HpServicesDescription" => "Останавливает 5 HSA-служб на время работы; драйверы HP остаются активными",
        "HpServicesError" => "Не удалось изменить состояние служб HP. Подробности записаны в журнал.",
    ...
    private static string Ukrainian(string key) => key switch
    {
        ...
        "StartWithWindowsDescription" => "Автоматично запускає програму в треї після входу до системи",
        "StartupChangeError" => "Не вдалося змінити автозапуск. Перевірте доступ до налаштувань Windows.",
        "HpServices" => "Призупиняти зайві служби HP",
        "HpServicesDescription" => "Зупиняє 5 HSA-служб на час роботи; драйвери HP залишаються активними",
        "HpServicesError" => "Не вдалося змінити стан служб HP. Подробиці записано до журналу.",
    ...
    private static string English(string key) => key switch
    {
        ...
        "StartWithWindowsDescription" => "Automatically starts the app in the notification area after sign-in",
        "StartupChangeError" => "Could not change startup. Check access to Windows settings.",
        "HpServices" => "Pause optional HP services",
        "HpServicesDescription" => "Stops five HSA services while the app runs; HP hardware drivers stay active",
        "HpServicesError" => "Could not change the HP service state. Details were written to the log.",
