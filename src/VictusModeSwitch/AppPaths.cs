...
internal static class AppPaths
{
    ...
    public static readonly string HpServiceSessionFile = Path.Combine(DataDirectory, "hp-service-session.json");
    public static readonly string BrokerLockFile = Path.Combine(DataDirectory, "broker.lock");
